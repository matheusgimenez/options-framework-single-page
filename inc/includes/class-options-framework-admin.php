...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
                'page_title' => 'Configuração Single pag',
	...
	function optionsframework_admin_bar() {
        ...
        $wp_admin_bar->add_menu( array(
            'parent' => false,
            'id' => 'of_theme_options',
            'title' => 'Configuração Single Page',
    ...
    function admin_menu(){
        ...
        add_menu_page( 'Configuração Single Page', 'Configuração Single Page', 'manage_options', 'themes.php?page=' . $menu['menu_slug'], '', 'dashicons-admin-site', 6 );
    }
}